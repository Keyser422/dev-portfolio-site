  ...
  return (
    <div className="projects-page">
        ...
        <div className="row justify-content-center">
            <div className="col-12 col-md-4 text-center">
                <Card className="project-card project-card-pawsitive">
                    ...
                    <ListGroup>
                        ...
                        <ListGroup.Item className="list-group-technoligies ">Backend: Python, FastAPI, PostgreSQL ||  Frontend: Javascript, React</ListGroup.Item>
            ...
            <div className="col-12 col-md-4 text-center">
                <Card className="project-card project-card-portfolio">
                    <Card.Img variant="top" src="/img/Blackout_Arms_Logo.png" alt="My Portfolio Website" className="bo-project-image" />
                    <Card.Body>
                        <Card.Title className="cards-title">
                            Point of Sale Web Application for BlackOut Arms llc.
                        </Card.Title>
                        <Card.Text className="cards-text">
                    ...
                    <ListGroup>
                        <ListGroup.Item className="list-group-tech-stack">Tech Stack</ListGroup.Item>
                        <ListGroup.Item className="list-group-technoligies ">Backend: Python, FastAPI, PostgreSQL ||  Frontend: Javascript, React, React-Native</ListGroup.Item>
                        <ListGroup.Item className="list-group-technoligies ">Libraries: Bootstrap.css, Email.js, TBD</ListGroup.Item>
                    </ListGroup>
                    <Card.Body>
                        <Card.Link href="https://www.github.com/Keyser422" target="_blank" rel="noopener noreferrer">
                            <img src="img/github.png" alt="linkedin icon" width="40px" />
